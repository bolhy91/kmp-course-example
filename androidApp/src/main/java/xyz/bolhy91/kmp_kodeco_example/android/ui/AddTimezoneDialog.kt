...
import xyz.bolhy91.kmp_kodeco_example.TimeZoneHelper
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    ...
                    Text(text = stringResource(id = xyz.bolhy91.kmp_kodeco_example.android.R.string.cancel))
                }
                Spacer(modifier = Modifier.size(16.dp))
                Button(
                    onClick = {
                    ...
                    Text(text = stringResource(id = xyz.bolhy91.kmp_kodeco_example.android.R.string.add))
                }
            }
        }
    }
